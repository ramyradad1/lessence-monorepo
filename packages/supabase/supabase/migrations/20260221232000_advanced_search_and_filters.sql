-- Add gender_target to products
ALTER TABLE public.products 
ADD COLUMN IF NOT EXISTS gender_target TEXT CHECK (gender_target IN ('men', 'women', 'unisex'));

-- Update existing products to have a generic gender target if needed (optional)
UPDATE public.products SET gender_target = 'unisex' WHERE gender_target IS NULL;

-- Create advanced search RPC
