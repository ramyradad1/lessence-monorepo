...
class AppLocalizations {
  ...
  static const Map<String, Map<String, String>> _strings = {
    'en': {
      ...
      'apply': 'Apply',
      'discount_success': 'Coupon applied successfully',
      'giftOptions': 'Gift Options',
      'is_gift': 'Is this a gift?',
      'gift_wrap': 'Gift wrap',
      'gift_message': 'Gift Message',
      'gift_message_placeholder': 'Write a short message...',
      'subtotal': 'Subtotal',
      'discount': 'Discount',
      'payment_method': 'Payment Method',
      'credit_card': 'Credit / Debit Card (Paymob)',
      'cash_on_delivery': 'Cash on Delivery',
      'pay_now': 'Pay Now',
      'place_order': 'Place Order',
      'order_success_message':
          'Hello! I just placed an order with reference: {{orderRef}}',
    },
    'ar': {
      ...
      'apply': 'تطبيق',
      'discount_success': 'تم تطبيق الكوبون بنجاح',
      'giftOptions': 'خيارات الهدية',
      'is_gift': 'هل هذا طلب هدية؟',
      'gift_wrap': 'تغليف هدية',
      'gift_message': 'رسالة الهدية',
      'gift_message_placeholder': 'اكتب رسالة قصيرة...',
      'subtotal': 'المجموع الفرعي',
      'discount': 'الخصم',
      'payment_method': 'طريقة الدفع',
      'credit_card': 'بطاقة الائتمان / الخصم المباشر (Paymob)',
      'cash_on_delivery': 'الدفع عند الاستلام',
      'pay_now': 'ادفع الآن',
      'place_order': 'تأكيد الطلب',
      'order_success_message':
          'مرحباً! لقد قمت للتو بطلب برقم مرجعي: {{orderRef}}',
    },
  };
