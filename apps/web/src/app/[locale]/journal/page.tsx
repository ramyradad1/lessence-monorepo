  ...
  return (
    <>
      ...
      <div className="min-h-screen pt-32 pb-20 px-4">
        ...
        <h1 className="text-5xl font-sans text-white mb-12 uppercase tracking-widest text-center">Journal</h1>
          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-[#1e1b16] border border-white/5 rounded-2xl overflow-hidden group hover:border-primary/20 transition-all duration-500">
              ...
              <div className="p-8">
                ...
                <p className="text-fg-muted text-sm leading-relaxed mb-6">Discover the hidden secrets of mixing rare essences to create your own signature trail...</p>
                <span className="text-xs text-fg-faint">Coming Spring 2024</span>
              </div>
            </div>
          ))}
        </div>
