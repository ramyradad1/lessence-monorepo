    ...
    <View className="mt-8 pt-8 border-t border-white/10">
      ...
      {isWriting && (
        <View className="bg-surface-dark p-4 rounded-xl border border-white/5 mb-6">
          ...
          <Text className="text-white/40 text-xs uppercase tracking-widest font-bold mb-2">
            Rating
          </Text>
      ...
      <View className="flex-row gap-3">
        {isWriting && (
          <>
            ...
            >
              <Text className="text-white/60 font-bold uppercase tracking-wider text-xs">
                Cancel
              </Text>
            </TouchableOpacity>
          </>
      ...
      {reviews.length === 0 ? (
        ...
        <View className="flex-col gap-4 mt-2">
          {reviews.map((review) => (
            <View
              key={review.id}
              className="p-4 rounded-xl border border-white/5 bg-surface-dark"
            >
                ...
                <View className="flex-row items-center gap-2">
                  {review.is_verified_purchase && (
                    <View className="bg-green-500/10 px-2 py-1 rounded">
                      <Text className="text-green-400 text-[8px] uppercase tracking-wider font-bold">
                        Verified
                      </Text>
                    </View>
                  )}
